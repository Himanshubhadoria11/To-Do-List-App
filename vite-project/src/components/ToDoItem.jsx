    ...
    return (
        <article className={`flex w-full rounded-sm ${todo?.isCompleted ? "opacity-50" : "opacity-100"}`}>
            ...
            />
            {
                !editEnabled ?
                    <button
                        ...
                        className="text-lg bg-sky-600 text-white p-2 border-2 border-white rounded-xl"
                    >
            ...
            <button
                ...
                className="text-lg text-white bg-sky-600 p-2 border-e-2 border-y-2 border-white rounded-xl" >
            ...
            <button
                ...
                className="text-lg text-white bg-sky-600 p-2 border-y-2 border-e-2 border-white rounded-xl"
            >
